...
export const CONTRACTS = {
  ...
  alphaAddress:
    process.env.NEXT_PUBLIC_ALPHA_ADDRESS || '0xcBfF385e24A089046F9C68F4606a5E802E38DDDF',
  gammaPackAddress:
    process.env.NEXT_PUBLIC_GAMMA_PACKS_ADDRESS || '0xEBB41F3Ec566d650CE5560C0Cbc9916EFcF9a2a2',
  gammaCardsAddress:
    process.env.NEXT_PUBLIC_GAMMA_CARDS_ADDRESS || '0x4d520DDb845dCB215F2343eA3F70523F8Fb081fE',
  gammaOffersAddress:
    process.env.NEXT_PUBLIC_GAMMA_OFFERS_ADDRESS || '0x34DC39F81DDC8f1F514d7e7990d37807026975bd'
}
