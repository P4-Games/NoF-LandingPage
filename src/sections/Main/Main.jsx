  ...
  const Page2 = () => (
    <React.Fragment>
      ...
      <div className='book_container'>
        <Image
          src={"/images/hero/book-menu-1.png"}
          alt='text box'
          fill
        />
      </div>
      ...
      {!windowSize.mobile && (
        <>
          ...
          <div className='text-blocker'>
            <h4>
              Number One Fan & P4 Tech Solutions
