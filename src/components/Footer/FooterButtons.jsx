    ...
    <div className='footer__buttons'>
      ...
      {showButtons[1] && buttonFunctions && buttonFunctions[1] && (
        <div
          ...
          className={(footerButtonsClasses && footerButtonsClasses[1]) ?? 'footer__buttons__greenbtn_custom'}
        >
          <></>
        </div>
      )}
      {showButtons[2] && buttonFunctions && buttonFunctions[2] && (
        <div
          ...
          className={(footerButtonsClasses && footerButtonsClasses[2]) ?? 'footer__buttons__redbtn_custom'}
        >
          <></>
        </div>
      )}
      {showButtons[3] && buttonFunctions && buttonFunctions[3] && (
        <div
          ...
          className={(footerButtonsClasses && footerButtonsClasses[3]) ?? 'footer__buttons__yellowbtn_custom'}
        >
          <></>
        </div>
      )}
